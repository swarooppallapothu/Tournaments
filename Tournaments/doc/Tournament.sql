...
CREATE TABLE PLAYED_MATCHES (
    ...
    CREATED_BY INT NOT NULL,
    CONSTRAINT FK_PM_TEAM1 FOREIGN KEY (TEAMA) REFERENCES TEAMS(TEAM_ID) ON DELETE CASCADE,
    CONSTRAINT FK_PM_TEAM2 FOREIGN KEY (TEAMB) REFERENCES TEAMS(TEAM_ID) ON DELETE CASCADE,
